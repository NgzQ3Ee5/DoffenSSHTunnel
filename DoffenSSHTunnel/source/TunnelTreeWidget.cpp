...
{
	m_pDragItem = NULL;
    this->setItemDelegate(new TunnelTreeWidgetItemDelegate(this));
}
...
//override TruncOrViewportClipToolTipDelegate
QString TunnelTreeWidgetItemDelegate::getTooltipDisplayText(const QModelIndex &index) const {
