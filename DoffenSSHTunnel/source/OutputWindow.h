...
public:
  ...
  /**
   * @brief setAutoCloseVisible
   * @param visible
   */
  void setAutoCloseVisible(bool visible);
   ...
   **/
  void setStdoutColor(const QColor &newColor) { _stdoutColor = newColor; }
   ...
   **/
  void setStderrColor(const QColor &newColor) { _stderrColor = newColor; }
...
public slots:
  ...
  bool findString(QString s, bool reverse, bool casesens, bool words);
