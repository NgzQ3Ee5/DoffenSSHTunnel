...
{
    // We are looking for the string
    static int prevmatch1=0,prevmatch3=0,prevmatch6=0,prevmatch7=0; // If the "password" prompt is repeated, we have the wrong password.
    static int state0, state1, state2, state3, state4, state5, state6, state7;
